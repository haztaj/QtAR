...
- **Research-first pivot (2026-07-06, user-directed).** Methodology findings (grounded in
  ...
  test sequences: aligned-hit 84.5%, unit SER 15.9%, ayah-chain SER 16.5%, exact sequences
  46.6%; sequential context resolves exact-twin units 45% → 78%. Iteration history (v1–v9 +
  filter bank, each step measured) in research/CLAUDE.md.
